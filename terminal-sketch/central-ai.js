...
function instructions(character, turn) {
  return [personality, contract, 'Current performance emphasis: '+replay(turn.state.replayVariant).focus,
    ...
    'Always reply in English, even when the player writes another language. Identity, patient role, destination, course and captain continuity must remain undisclosed until the corresponding patient, course or neural fact appears in allowed facts. Do not address the player by a hidden name. Do not confirm guesses about undiscovered facts.',
